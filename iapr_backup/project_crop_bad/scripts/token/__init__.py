import cv2
import numpy as np
from project_crop_bad.scripts.dataset import WIDTH, HEIGHT, Player
from project_crop_bad.scripts.preprocessing.rygb import filter_color
from project_crop_bad.scripts.preprocessing.sectors import SECTOR_SRC_WIDTH, SECTOR_SRC_HEIGHT
