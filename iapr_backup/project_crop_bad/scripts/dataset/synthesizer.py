...
from project_crop_bad.scripts.dataset import PARENT_PATH, CARD_LOOKUP, CARDS_COUNT, Card
from project_crop_bad.scripts.preprocessing.sectors import SECTOR_SRC_WIDTH, SECTOR_SRC_HEIGHT, SECTOR_END_SIZE
