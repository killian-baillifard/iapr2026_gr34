...
from project_crop_bad.scripts.dataset import CARDS_COUNT
from project_crop_bad.scripts.preprocessing.sectors import slice_sectors
from project_crop_bad.scripts.dataset import PARENT_PATH, Card, load_train_images_paths_and_labels
from project_crop_bad.scripts.dataset.synthesizer import SYNTHESIZED_DIRECTORY, SYNTHESIZED_LABELS_PATH, SYNTHESIZED_SECTORS, synthesized_image_path
from project_crop_bad.scripts.preprocessing import preprocess
from project_crop_bad.scripts.preprocessing.rygb import rygb2rgb
