...
combined_ds = ConcatDataset([AugmentedDataset(train_ds), AugmentedDataset(synth_ds, multiplier=5)])
...
print(f"[hires {HIRES[0]}px] Real train: {n_train} (×5 aug) | Synthetic: {len(synth_ds)} (×2 aug) | Val: {n_val}")
...
if __name__ == "__main__":
    train(
        ...
        use_focal     = True,
        center_weight = 0.1,
        save_path     = "best_model_640_sobel.pth",
    )
